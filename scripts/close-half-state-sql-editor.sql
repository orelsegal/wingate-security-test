-- ═══════════════════════════════════════════════════════════════════════════
-- CLOSE STUDENT HALF-STATE · חבילת SQL Editor · פרויקט flfemffhswlpgpbvhuvy
-- להריץ בחלון ה-production הבא, אחרי אישור. טרנזקציה אחת, בטוח להרצה כפולה.
-- ‏grant_role יסרב מעכשיו ל-student (המסלול היחיד: אישור בקשת גישה),
-- ‏ו-admin_list_users יחזיר גם linked_student. אין שינוי נתונים.
-- ROLLBACK: הרצת ההגדרות הקודמות מהמיגרציה 20260819210000.
-- ═══════════════════════════════════════════════════════════════════════════
begin;
