...
const ParentHome = () => {
  ...
  const cards: ActionCard[] = [
    ...
    { id: "schedule", title: "מערכת שעות", description: "תצוגה שבועית בתוך סביבת וינגייט", icon: Calendar, color: "bg-secondary", iconColor: "text-foreground/80", external: "https://tailor-my-tutor.lovable.app" },
